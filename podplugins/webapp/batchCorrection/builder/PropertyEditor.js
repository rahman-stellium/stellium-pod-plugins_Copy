...
return PropertyEditor.extend("stellium.ext.podpluginsCopyRahman.batchCorrection.builder.PropertyEditor", {
    constructor : function(sId, mSettings) {
        PropertyEditor.apply(this, arguments);
        this.setI18nKeyPrefix("batchCorrectionConfig.");
        this.setResourceBundleName("stellium.ext.podpluginsCopyRahman.batchCorrection.i18n.builder");
        this.setPluginResourceBundleName("stellium.ext.podpluginsCopyRahman.batchCorrection.i18n.i18n");
    },
    ...
    handleInputChange : function (sDataFieldName, sValue, oSource) {
        ...
        if(sDataFieldName !== "customField1"){
            ...
            if(!isValid) {
                ...
                oSource.setValueStateText(this.getI18nText("batchCorrectionConfig.invalidCharcName"));
            }
            else if(sValue.split(",").length > 4) {
                oSource.setValueState(sap.ui.core.ValueState.Error);
                oSource.setValueStateText(this.getI18nText("batchCorrectionConfig.charcNameLimit"));
            }
            else {
